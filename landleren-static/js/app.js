...
const imgLink = "https://static-landleren.digitalinnovation.be/"; // linkt naar de map waar alle vlaggen zich in bevinden - deze staan op een een andere server op de laadsnelheid te verbeteren door deze niet constant opnieuz op te moeten vragen
